...
@NamedQueries({
    ...
    , @NamedQuery(name = "Amigos.findByPair", query = "SELECT a FROM Amigos a WHERE (a.usuario.id = :amigo1 AND a.usuario1.id= :amigo2) OR (a.usuario1.id = :amigo1 AND a.usuario.id= :amigo2)")
